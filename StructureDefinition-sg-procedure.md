# WHO SMART Guidelines Procedure - SMART Base Clinical v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **WHO SMART Guidelines Procedure**

## Resource Profile: WHO SMART Guidelines Procedure 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/base-clinical/StructureDefinition/sg-procedure | *Version*:1.0.0 |
| Draft as of 2026-09-04 | *Computable Name*:SGProcedure |

 
The WHO SMART Guidelines Procedure profile defines conformance requirements and exchange expectations for Procedure resources in WHO Smart Guidelines content. 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/smart.who.int.base-clinical|current/StructureDefinition/StructureDefinition-sg-procedure.json)
...
Other representations of profile: [CSV](StructureDefinition-sg-procedure.csv), [Excel](StructureDefinition-sg-procedure.xlsx), [Schematron](StructureDefinition-sg-procedure.sch) 
