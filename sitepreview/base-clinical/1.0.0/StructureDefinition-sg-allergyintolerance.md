# WHO SMART Guidelines AllergyIntolerance - SMART Base Clinical v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **WHO SMART Guidelines AllergyIntolerance**

## Resource Profile: WHO SMART Guidelines AllergyIntolerance 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/base-clinical/StructureDefinition/sg-allergyintolerance | *Version*:1.0.0 |
| Draft as of 2026-09-04 | *Computable Name*:SGAllergyIntolerance |

 
The WHO SMART Guidelines AllergyIntolerance profile defines conformance requirements and exchange expectations for AllergyIntolerance resources in WHO Smart Guidelines content. 

**Usages:**

* Refer to this Profile: [WHO SMART Guidelines CarePlan](StructureDefinition-sg-careplan.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/smart.who.int.base-clinical|current/StructureDefinition/StructureDefinition-sg-allergyintolerance.json)
...
Other representations of profile: [CSV](StructureDefinition-sg-allergyintolerance.csv), [Excel](StructureDefinition-sg-allergyintolerance.xlsx), [Schematron](StructureDefinition-sg-allergyintolerance.sch) 
