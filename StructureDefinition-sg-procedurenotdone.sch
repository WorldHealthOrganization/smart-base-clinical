...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Procedure/f:code">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/cqf-notDoneValueSet']) &gt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/cqf-notDoneValueSet': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/cqf-notDoneValueSet']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/cqf-notDoneValueSet': maximum cardinality of 'extension' is 1</sch:assert>
