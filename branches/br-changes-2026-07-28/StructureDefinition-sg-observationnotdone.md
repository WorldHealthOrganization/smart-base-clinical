# WHO SMART Guidelines Observation Not Done - SMART Base Clinical v2.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **WHO SMART Guidelines Observation Not Done**

## Resource Profile: WHO SMART Guidelines Observation Not Done 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/base-clinical/StructureDefinition/sg-observationnotdone | *Version*:2.0.0 |
| Draft as of 2026-09-01 | *Computable Name*:SGObservationNotDone |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/smart.who.int.base-clinical|current/StructureDefinition/StructureDefinition-sg-observationnotdone.json)
...
Other representations of profile: [CSV](StructureDefinition-sg-observationnotdone.csv), [Excel](StructureDefinition-sg-observationnotdone.xlsx), [Schematron](StructureDefinition-sg-observationnotdone.sch) 
